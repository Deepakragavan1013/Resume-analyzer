...
interview_videos = [
    ...
    "https://youtu.be/p6UUNzYwrOA",  # Harvard Career Services - Resume Tips
    "https://youtu.be/5nqPQ7bL1Vg",  # Simplilearn - How to Build a Resume for Freshers
    "https://youtu.be/Y7ExEJ5NpyU",  # Great Learning - Resume Building for Freshers
    "https://youtu.be/qkI8bF_GZJg",  # Resume Review by Career Development Guru

    # Interview Preparation (HR + Technical)
    "https://youtu.be/JoF0Z7nVSrA",  # Interview Warm-Up (Google)
    "https://youtu.be/2mDW8TzFt2g",  # Top HR Questions
    "https://youtu.be/y8YH0Qbu5h4",  # Tell Me About Yourself
    "https://youtu.be/Vi9bxu-M-ag",  # How to Explain Projects in Interviews

    # Projects & Explanation
    "https://youtu.be/qjr5U7kYvmo",  # How to Present Projects Effectively
    "https://youtu.be/Uh9G3ZbrH0A",  # Final Year Project Presentation Tips

    # SQL & Python Interview
    "https://youtu.be/7S_tz1z_5bA",  # SQL Interview Questions
    "https://youtu.be/d5Q1f0Yvdag",  # Python Interview for Freshers
]